...
module "application-gateway" {
  ...
  firewall_policy_id   = "/subscriptions/xxx/resourceGroups/xxx/providers/Microsoft.Network/applicationGatewayWebApplicationFirewallPolicies/cust1-wafpolicy"
  ...
  ssl_certificates = [{
    ...
    # data     = "./keyBag.pfx"
    # password = "P@$$w0rd123"
    key_vault_secret_id = "https://xxx.vault.azure.net/secrets/summerlister/xxx"
  }]
